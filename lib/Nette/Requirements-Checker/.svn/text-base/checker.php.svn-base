...
$tests[] = array(
	...
	'description' => 'Session auto-start is enabled. Nette Framework requires this to be disabled, otherwise NSession will not work properly.',
);
...
$tests[] = array(
	...
	'description' => 'Bundled GD extension is absent. You will not be able to use some function as <code>NImage::filter()</code> or <code>NImage::rotate()</code>.',
);

$tests[] = array(
	'title' => 'ImageMagick library',
	'required' => FALSE,
	'passed' => @exec('identify -format "%w,%h,%m" ' . addcslashes(dirname(__FILE__) . '/assets/logo.png', ' ')) === '108,46,PNG', // @ - may be disabled
